	...
	<view class="content">
		...
		<view v-if="list.length === 0" class="default">
			<view class="image-default">
				<image src="@/static/tabbar/add.png" mode="aspectFit"></image>
			</view>
			<view class="default-info">
				<view class="default-info_text">您还没有创建便签呢</view>
		...
		<view v-if="active" class="create-content" :class="{'create-show':textShow}">
			<view class="create-content-box" >
				<view class="create-input">
					<input type="text" v-model="content_value"  placeholder="请输入您要创建的便签"/>
				</view>
				<!-- 发布按钮 -->
